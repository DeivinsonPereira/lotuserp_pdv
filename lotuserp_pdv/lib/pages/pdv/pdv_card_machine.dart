...
class PdvCardMachinePage extends StatefulWidget {
  const PdvCardMachinePage({super.key});

  @override
  State<PdvCardMachinePage> createState() => _PdvCardMachinePageState();
}

class _PdvCardMachinePageState extends State<PdvCardMachinePage> {
