...
class CreatePasswordCloseRegister extends StatelessWidget {
  const CreatePasswordCloseRegister({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildContinueButton() {
      return SizedBox(
        ...
        child: CustomElevatedButton(
          function: () async {
            LogicPasswordCloseRegister().navigationToConfirmPassword(context);
          },
    ...
    Widget _buildHeader() {
      return HeaderPopupMobile(text: 'CRIAR SENHA', icon: Icons.lock);
    }
