...
tipo_recebimento _tipo_recebimentoDeserialize(
  ...
  final object = tipo_recebimento(
    ...
    id: id,
    id_empresa: reader.readLongOrNull(offsets[2]),
    id_fpagto: reader.readLongOrNull(offsets[3]),
    id_pcontas: reader.readLongOrNull(offsets[4]),
    imp_comprovante: reader.readLongOrNull(offsets[5]),
    listar_pdv: reader.readLongOrNull(offsets[6]),
    obrigar_nfce: reader.readLongOrNull(offsets[7]),
    permite_troco: reader.readLongOrNull(offsets[8]),
    pix_integrado: reader.readLongOrNull(offsets[9]),
    solicitar_senha: reader.readLongOrNull(offsets[10]),
    status: reader.readLongOrNull(offsets[11]),
    tef: reader.readLongOrNull(offsets[12]),
    tipo_forma: reader.readLongOrNull(offsets[13]),
  );
  return object;
}
