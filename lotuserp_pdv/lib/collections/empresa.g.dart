...
const EmpresaSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'fone2': PropertySchema(
      id: 9,
      name: r'fone2',
      type: IsarType.string,
    ),
    r'fone3': PropertySchema(
      id: 10,
      name: r'fone3',
      type: IsarType.string,
    ),
...
empresa _empresaDeserialize(
  ...
  final object = empresa(
    ...
    estoque_grade: reader.readLongOrNull(offsets[6]),
    fantasia: reader.readStringOrNull(offsets[7]),
    fone1: reader.readStringOrNull(offsets[8]),
    fone2: reader.readStringOrNull(offsets[9]),
    fone3: reader.readStringOrNull(offsets[10]),
    id: id,
    insc_estadual: reader.readStringOrNull(offsets[11]),
    insc_municipal: reader.readStringOrNull(offsets[12]),
    municipio: reader.readStringOrNull(offsets[13]),
    municipio_uf: reader.readStringOrNull(offsets[14]),
    numero: reader.readStringOrNull(offsets[15]),
    param_nf_crt: reader.readLongOrNull(offsets[16]),
    param_pdv_bloq_est_neg: reader.readLongOrNull(offsets[17]),
    param_pdv_cartao_gerarparc: reader.readLongOrNull(offsets[18]),
    param_pdv_cliente: reader.readLongOrNull(offsets[19]),
    param_pdv_codigopesagem: reader.readLongOrNull(offsets[20]),
    param_pdv_comanda_producao: reader.readLongOrNull(offsets[21]),
    param_pdv_formapagto: reader.readLongOrNull(offsets[22]),
    param_pdv_gerar_senha: reader.readLongOrNull(offsets[23]),
    param_pdv_imp_comprovante: reader.readLongOrNull(offsets[24]),
    param_pdv_imp_cp_nf_venda: reader.readLongOrNull(offsets[25]),
    param_pdv_informa_cliente: reader.readLongOrNull(offsets[26]),
    param_pdv_permitir_desconto: reader.readLongOrNull(offsets[27]),
    param_pdv_prodcomposto: reader.readLongOrNull(offsets[28]),
    param_pdv_senha_cancelar: reader.readLongOrNull(offsets[29]),
    param_pdv_tipo_desconto: reader.readLongOrNull(offsets[30]),
    param_pdv_usar_pvista_pprazo: reader.readLongOrNull(offsets[31]),
    param_pdv_validar_cx_fechado: reader.readLongOrNull(offsets[32]),
    param_pdv_vendedor_venda: reader.readLongOrNull(offsets[33]),
    param_vendas_descmaximo: reader.readDoubleOrNull(offsets[34]),
    param_vendas_portador: reader.readLongOrNull(offsets[35]),
    param_vendas_tpcomissao: reader.readLongOrNull(offsets[36]),
    razao: reader.readStringOrNull(offsets[37]),
    site: reader.readStringOrNull(offsets[38]),
    usar_paf_nfce: reader.readLongOrNull(offsets[39]),
  );
  return object;
}
